...
describeIterableArg("countBy", ({ wrap }) => {
  describe("dataFirst", () => {
    ...
    test("symbols", () => {
      ...
      const data = wrap([mySymbolA, mySymbolB, mySymbolA]);
      const result = countBy(data, (x) => x);
    ...
    test("mixed data types", () => {
      ...
      const data = wrap([1, "a", 1, mySymbol, "A", mySymbol]);
